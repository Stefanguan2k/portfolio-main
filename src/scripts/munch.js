...
darkBtn.addEventListener("click", () => {
  if (finalImg.getAttribute("data-dark") === "false") {
    finalImg.setAttribute("data-dark", true);
    finalImg.src = "/src/assets/img/munchfinal2dm.jpg";
    darkBtn.innerHTML = `Light Prototype
    ...
    finalImgWrapper.style.background = "#252727";
    darkBtn.setAttribute('data-dark', true);
  } else {
    finalImg.setAttribute("data-dark", false);
    finalImg.src = "/src/assets/img/munchfinal2.jpg";
    darkBtn.innerHTML = `Dark Prototype
    ...
    finalImgWrapper.style.background = "#FFF";
